...
coco = media.Movie("Coco",
                   ...
                   "https://vignette.wikia.nocookie.net/disney/images/1/14/Co"
                   "co_poster.png/revision/latest?cb=20170912170727",
...
wall_e = media.Movie("WALL-E",
                   ...
                   "https://pixar-planet.fr/wp-content/uploads/2010/04/affic"
                   "he-walle-40.jpg",
...
big_hero6 = media.Movie("Big Hero 6",
                   ...
                   "high-tech heroes.",
                   "https://images-na.ssl-images-amazon.com/images/I/81%2BMTz"
                   "e25KL._SL1500_.jpg",
...
dragon = media.Movie("How to Train Your Dragon",
                   ...
                   "http://cdn.collider.com/wp-content/uploads/how-to-train-y"
                   "our-dragon-2-poster2.jpg",
...
ferdinand = media.Movie("Ferdinand",
                   ...
                   "rm,",
                   "https://i.pinimg.com/originals/74/54/57/745457295a72883a"
                   "4d3fc516adbc03e2.jpg",
...
brave = media.Movie("Brave",
                   ...
                   " with the present",
                   "https://lumiere-a.akamaihd.net/v1/images/open-uri20150422"
                   "-7119-1mm8kcq_30f3d3a4.jpeg?region=0,0,1000,1409",
...
monsters = media.Movie("Monsters",
                   ...
                   "https://vignette.wikia.nocookie.net/disney/images/f/fe/1"
                   "000px-Monsters_inc_ver1_xlg.jpeg/revision/latest?cb=2016"
                   "0202161958",
...
inside_out = media.Movie("Inside Out",
                   ...
                   "https://vignette.wikia.nocookie.net/disney/images/f/fb/I"
                   "nside-Out-60.png/revision/latest?cb=20150304211113",
                   "https://www.youtube.com/watch?v=QxrQ6BaijAY")
movies = [coco, up, wall_e, big_hero6, dragon, ferdinand, brave, monsters, inside_out]
